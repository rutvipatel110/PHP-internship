<?php
    ...
    $q = mysqli_query($connection,
        "insert into tbl_user(user_id,user_name,user_gender,user_dob,user_email,user_mobile,user_address,user_password,user_area,user_pincode) values('{$id}','{$name}','{$gender}','{$dob}','{$email}','{$number}','{$address}','{$password}','{$area}','{$pincode}')") or die(mysqli_error($connection)) ;
        if($q){
